                    ...
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   name="orderNo" id="order_id"  type="hidden" value="${(orderitems.order_id)!}" readonly="readonly">
                        </div>
                    </div>
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   name="total" id="book_id" type="hidden" value="${(orderitems.book_id)!}" readonly="readonly">
                        </div>
                    </div>
                </div>
...
<div class="layui-col-md12">
    <table id="orderDetailsList" class="layui-table"  lay-filter="orderDetails"></table>
</div>
