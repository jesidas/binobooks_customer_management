...
(function (layui, window, factory) {
	...
	var v = '4.0.0.0910',
		...
		} }, { icon: 'xm-iconfont icon-qingkong', name: 'Clear All', click: function click(id, cm) {
			cm.removeAll(id, true, true);
		} }, { icon: 'xm-iconfont icon-fanxuan', name: 'Anti-Select', click: function click(id, cm) {
			cm.reverse(id, true, true);
		} }, { icon: 'xm-iconfont icon-pifu', name: 'Change Skin Color', click: function click(id, cm) {
			cm.skin(id);
		} }],
