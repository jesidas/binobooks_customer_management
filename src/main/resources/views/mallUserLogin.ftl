        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                <div class="layui-form-item logo-title">
                    <h1>BinoBook Customer Self-Info Login</h1>
                </div>
            ...
            <br/>
            <h3 style="color:green;font-weight:bold;"><a href="${ctx}/register">New MallUser Register</a></h3>
        </div>
    </div>
</div>
<script src="${ctx}/js/mallUserLogin.js" charset="utf-8"></script>
</body>
</html>