var apiContent = {
	...
	_init: function() {
		...
		var setting_nodes =[
			{id:1, pId:0, t:"public.static.js.adminUser.setting.ftl", name:"var setting = {", open:true},
		...
		var function_nodes =[
			...
			{id:401, pId:4, t:"public.static.js.adminUser.setting.ftl", name:"public.static.js.adminUser.setting.ftl", iconSkin:"core", showAPI:true},
	...
	openAPI: function() {
		if (apiContent.searchNodes.length > 0) {
			...
			if (node.tId.indexOf("public.static.js.adminUser.setting.ftl") > -1) {
