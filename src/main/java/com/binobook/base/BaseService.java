...
//        System.out.println("BaseService.SelectByPrimaryKey says: id = "+id);
        T temp = baseMapper.selectByPrimaryKey(id);
//        System.out.println("BaseService.SelectByPrimaryKey says: temp = "+temp.toString());
        return temp;
    }
